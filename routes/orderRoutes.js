...
import { createBookingController as directBookingController } from "../controllers/bookingControllers.js";
import { verifyToken } from "../middlewares/authMiddleware.js";

const router = express.Router();

router.get("/my-orders", verifyToken, getMyOrdersController);
router.post("/booking", verifyToken, directBookingController);
