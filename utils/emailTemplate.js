          ...
          <tr>
            <td style="padding:40px 48px;">
              ...
              <p style="margin:0 0 32px;font-size:16px;color:#475569;text-align:center;line-height:24px;">
                We received a request to reset the password associated with your HireSmart account. Please use the code below to securely reset your password.
              </p>
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#475569;text-align:center;line-height:24px;">
                Enter this code in the HireSmart app. For security reasons, this code will expire in <strong>15 minutes</strong>.
              </p>
